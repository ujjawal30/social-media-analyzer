    ...
    <div className="absolute inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)]">
      <div className="flex flex-col items-center justify-center h-full">
        <div className="bg-white/20 backdrop-blur-lg rounded-2xl shadow-2xl p-8 w-full max-w-md transform transition-all hover:scale-105 hover:shadow-3xl border border-white/10">
          <h1 className="text-3xl font-semibold text-center text-white mb-2 drop-shadow-lg">
            EngageWise
          </h1>
          <h2 className="text-lg font-light text-center text-white/80 mb-6 drop-shadow-lg">
            AI-powered social media post analysis
          </h2>
